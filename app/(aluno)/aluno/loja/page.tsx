    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-gray-500 mt-1">Utensílios e ingredientes para sua cozinha</p>
        </div>
        <CartButton />
      </div>
      ...
      {!products || products.length === 0 ? (
        <div className="bg-white rounded-xl border border-gray-200 p-16 text-center">
          ...
          <p className="text-gray-400 text-sm mt-1">Em breve novos produtos serão adicionados.</p>
        </div>
      ) : (
